...
The VCF wrangling pipeline

- A tool for converting VCF files to .TSV files
...
def helpMessage() {
  ...
  ==========================================
	...
	nextflow run ${pipeline_name}.nf --vcf_file <vcf file for convertion> [--output_dir path to results ]

	  --vcf_file	<- The VCF file that is going to be treated
...
*/
pipeline_name = "nf_vcf_wrangling"

/*
  Initiate default values for parameters
  to avoid "WARN: Access to undefined parameter" messages
*/
params.vcf_file = false // default is false to not trigger help message
...
*/
if ( !params.vcf_file) {
  log.error " Please provide the --vcf_file \n\n" +
...
*/
params.output_dir = file(params.vcf_file).getParent() //!! maybe creates bug, should check
...
log.info"""
==========================================
A tool for making a VCF transformation to a .tsv file
v${version}
==========================================
"""
...
script_R = Channel.fromPath("./nf_modules/wrangling.R")


/* Import modules
*/
 include {vcf_t1; vcf_t2} from './nf_modules/modules.nf'
